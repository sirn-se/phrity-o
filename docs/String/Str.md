# [Docs](../../README.md) / [String](../String.md) / Str

Generic string class. Uses the following traits;
...
```php
class Str implements Stringable, Comparable
{
    use CoercionTrait;
    use ComparableTrait;
    use InvokableTrait;
...
$string = new Str("hey");
$string("joe"); // Invokable support
$string->equals(new Str("hello")); // Comparison support
echo $string; // Stringable support
```
