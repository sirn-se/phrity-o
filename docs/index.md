...
| --- | --- | --- | --- |
| Arr | `array` | [ArrayAccess](https://www.php.net/manual/en/class.arrayaccess.php) [Comparable](https://github.com/sirn-se/phrity-comparison) | [Documentation](class.arr.md)
| Obj | `obj` | | [Documentation](class.obj.md)
